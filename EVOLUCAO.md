...
| O vermelho de erro × "as nove cores" | O autor pediu exatamente as nove cores da marca. `--color-alerta` (#8a3a2a sobre #f4e6df) ficou como a única cor fora delas, em apagar jornada, sair do plano e apagar conta — é cor de estado, e trocar por contorno de tinta tiraria o sinal de perigo de quem vai perder dado. O revisor de acabamento marcou como aberto até o autor confirmar; o contrato de direção registra a exceção | **Pendente de decisão** |
